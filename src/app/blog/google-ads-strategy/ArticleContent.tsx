        ...
        <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 24px 80px' }}>
          <div style={{ maxWidth: '800px', margin: '0 auto' }}>
            ...
            <section id="layer-1">
              ...
              <p style={paragraphStyle}>
                The first strategic decision is the one most accounts skip: what is this account paid to do. Generate leads? Drive revenue at a target margin? Build pipeline for a sales team? Create demand for a category that converts later? Each answer implies a different optimization target and, just as important, a different definition of waste.
              </p>
              <p style={paragraphStyle}>
            ...
            <section id="cta">
              ...
              <div style={{ background: 'linear-gradient(135deg, #667eea 0%, #764ba2 100%)', borderRadius: '16px', padding: '32px', color: 'white', textAlign: 'center', marginTop: '40px' }}>
                ...
                <p style={{ fontSize: '16px', opacity: 0.95, marginBottom: '24px', lineHeight: 1.6 }}>
                  Kampaio runs the operational layer of your accounts (anomaly monitoring, cross-campaign budget reallocation, creative rotation) so your time goes to the six decisions that move the account. From $99/mo.
                </p>
