    ...
    <>
      ...
      <div style={{ minHeight: '100vh', background: 'white' }}>
        ...
        <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '20px 24px 0' }}>
          <Breadcrumbs />
          <ArticleHero slug="google-ads-attribution-models-guide" />
        </div>
        ...
        <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 24px 80px' }}>
          <div style={{ maxWidth: '800px', margin: '0 auto' }}>
            ...
            <section id="dda-works">
              ...
              <p style={pStyle}>
                When DDA outperforms last-click in practice: long path-length verticals (<a href="/blog/google-ads-for-b2b-saas" style={linkStyle}>B2B SaaS</a>, considered consumer purchases, high-AOV ecommerce), accounts running active upper-funnel campaigns (Display, YouTube, Demand Gen) alongside Search, and accounts where brand search currently gets disproportionate credit. The cleanest signal that DDA will pay off is a 30-day click-assisted-conversions report. Pull it and count how many paths have more than two ad touches. If above 25 percent are multi-touch, last-click is leaving money on the table.
              </p>
...
sequenceDiagram
  ...
  B->>B: Re-learn completes,<br/>tROAS settles
        ...
        <KeepReading slug="google-ads-attribution-models-guide" category="google-ads" />
      <Footer />
      </div>
    </>
  );
