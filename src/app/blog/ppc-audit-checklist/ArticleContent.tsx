    ...
    D -->|Strategic| K[Client memo at QBR]
      ...
      <div style={{ marginTop: '2.5rem', paddingTop: '1.5rem', borderTop: '1px solid #e5e7eb' }}>
        ...
        <ul style={{ listStyle: 'disc', paddingLeft: '1.25rem', margin: 0 }}>
          ...
          <li style={{ marginBottom: '0.4rem' }}><a href="/blog/how-to-switch-google-ads-agencies" style={{ color: 'var(--primary, #764ba2)', textDecoration: 'underline' }}>How to Switch Google Ads Agencies Without Losing Your Account</a></li>
        </ul>
      </div>
