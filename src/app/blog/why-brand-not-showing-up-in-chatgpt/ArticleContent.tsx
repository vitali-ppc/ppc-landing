...
export default function ArticleContent() {
  ...
  const jsonLd = {
    ...
    "keywords": "ChatGPT brand visibility, AI search visibility, generative engine optimization, entity signals, Knowledge Graph, schema markup, brand mentions, Perplexity, Gemini, AI Overviews, B2B SaaS, vendor research",
    "wordCount": 2093,
