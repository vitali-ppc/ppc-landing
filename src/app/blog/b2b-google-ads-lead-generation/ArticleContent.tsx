        ...
        <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 24px 80px' }}>
          <div style={{ maxWidth: '800px', margin: '0 auto' }}>
            ...
            <section id="campaign-structure">
              ...
              <p style={{ fontSize: '18px', lineHeight: '1.8', color: '#1e293b', marginBottom: '32px' }}>
                Within each campaign, keep this ad group discipline: one theme per ad group, 10-20 tightly related keywords maximum, 3-5 Responsive Search Ads per ad group. These numbers prevent ad group sprawl from fragmenting Smart Bidding's conversion signal. For ad copy within those groups, see <a href="/blog/responsive-search-ads-best-practices" style={{ color: '#764ba2', textDecoration: 'underline' }}>responsive search ads best practices</a> on pinning, asset variety, and Ad Strength signals.
              </p>
            ...
            <section id="keyword-strategy">
              ...
              <p style={{ fontSize: '18px', lineHeight: '1.8', color: '#1e293b', marginBottom: '28px' }}>
                <strong>Negative intent filter:</strong> Queries that look relevant but signal no purchase intent ("B2B lead generation jobs", "B2B Google Ads certification", "what is B2B marketing"). Build your negative keyword list from these before launch. A disciplined <a href="/blog/google-ads-negative-keywords-best-practices" style={{ color: '#764ba2', textDecoration: 'underline' }}>B2B negative keyword strategy</a> stops TOFU campaigns from burning budget on research queries and career searches.
              </p>
              <p style={{ fontSize: '18px', lineHeight: '1.8', color: '#1e293b', marginBottom: '32px' }}>
                Match type strategy for B2B: phrase match is the workhorse for MOFU (captures natural search variation without broad match chaos), exact match locks in BOFU terms, and broad match is only for TOFU with a tight audience overlay. Broad match without audience targeting in B2B is a budget risk, it serves to anyone searching the topic, including students, competitors, and job seekers. See our <a href="/blog/google-ads-keyword-match-types-explained" style={{ color: '#764ba2', textDecoration: 'underline' }}>Google Ads keyword match types guide</a> for a full breakdown of how match type behavior differs in practice from the official documentation.
              </p>
            </section>
            ...
            <section id="bidding-strategy">
              ...
              <p style={{ fontSize: '18px', lineHeight: '1.8', color: '#1e293b', marginBottom: '24px' }}>
                <strong>Phase 1 (weeks 1-4):</strong> Maximize Conversions, no CPA target. The goal here is purely data collection. Smart Bidding needs volume before it can model a reliable CPA estimate. If your campaign enters <a href="/blog/google-ads-bid-strategy-status-limited" style={{ color: '#764ba2', textDecoration: 'underline' }}>bid strategy status: limited</a>, conversion volume is the first thing to check before adjusting anything else.
              </p>
              <p style={{ fontSize: '18px', lineHeight: '1.8', color: '#1e293b', marginBottom: '24px' }}>
...
Pipeline attributed (90-day rolling) | Smart Bidding status`}
            ...
            <section id="scaling">
              ...
              <p style={{ fontSize: '18px', lineHeight: '1.8', color: '#1e293b', marginBottom: '28px' }}>
                Kampaio's AI <a href="/blog/google-ads-ai-agent" style={{ color: '#764ba2', textDecoration: 'underline' }}>agents</a> manage this system automatically, importing offline conversions from your CRM, adjusting bids by funnel stage, and flagging underperforming keywords before budget burns. On a flat subscription versus Optmyzr's $499+, <a href="/pricing" style={{ color: '#764ba2', textDecoration: 'underline' }}>Kampaio pricing vs. Optmyzr</a> makes the automation layer accessible for B2B teams that cannot justify enterprise tool pricing on a sub-$50K/month budget. See the full feature set at <a href="/features" style={{ color: '#764ba2', textDecoration: 'underline' }}>Kampaio's B2B campaign automation features</a>.
              </p>
