    ...
    <>
      ...
      <div style={{ minHeight: '100vh', background: 'white' }}>
        ...
        <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '20px 24px 0' }}>
          <Breadcrumbs />
          <ArticleHero slug="the-complete-guide-to-google-ads-quality-score-in-2025" />
        </div>
        {/* Article Header */}
          ...
          <div style={{ maxWidth: '800px', margin: '0 auto' }}>
            ...
            <section id="practical-tips">
              ...
              <ul style={{ fontSize: '18px', color: '#1e293b', lineHeight: '1.8', paddingLeft: '24px', marginBottom: '40px' }}>
                ...
                <li style={{ marginBottom: '16px' }}><strong>Don’t set and forget:</strong> Quality Score is dynamic, so keep optimizing. For a wider lens on account health, our walkthrough on <a href="/blog/google-ads-roas-dropped-suddenly" style={{ color: '#764ba2', textDecoration: 'underline' }}>why ROAS suddenly drops</a> shows how Quality Score interacts with bidding, tracking, and auction pressure.</li>
              </ul>
            </section>
            {/* Conclusion */}
        ...
        <KeepReading slug="the-complete-guide-to-google-ads-quality-score-in-2025" category="google-ads" />
      <Footer compact={true} />
      </div>
    </>
  );
