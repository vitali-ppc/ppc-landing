    ...
    <>
      ...
      <div style={{ minHeight: '100vh', background: 'white' }}>
        ...
        <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '20px 24px 0' }}>
          <Breadcrumbs />
          <ArticleHero slug="why-google-ads-strategy-fails-at-scale" />
        </div>
...
`}
  ...
  <text x="60" y="25" font-size="13" font-weight="600" fill="#1e293b">Incrementality decay hidden by attribution model</text>
            ...
            <section id="faq">
              ...
              <div style={{ marginBottom: '24px' }}>
                <p style={{ ...paragraphStyle, marginBottom: '12px' }}><strong>When should an agency switch from manual to autonomous <a href="/blog/5-tips-for-working-with-ai-ppc-tools" style={{ color: '#764ba2', textDecoration: 'underline' }}>PPC tools</a>?</strong></p>
        ...
        <KeepReading slug="why-google-ads-strategy-fails-at-scale" category="strategy" />
      <Footer />
      </div>
    </>
  );
