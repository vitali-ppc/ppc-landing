...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    type: 'article',
    images: [{ url: '/og/signs-you-need-to-fire-your-ppc-agency.png', width: 1200, height: 630, alt: 'Signs You Need To Fire Your Ppc Agency , kampaio.com/blog' }],
  },
  twitter: {
    card: 'summary_large_image',
    title: '8 Signs It\'s Time to Fire Your PPC Agency',
    description: '8 observable signs your PPC agency is failing, a self-scoring diagnostic, and a plan for what to do next: confront, switch, or go independent with AI tools.',
    images: ['/og/signs-you-need-to-fire-your-ppc-agency.png'],
  },
};
