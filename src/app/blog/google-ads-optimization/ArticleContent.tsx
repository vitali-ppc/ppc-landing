    ...
    <>
      ...
      <div style={{ marginTop: '2.5rem', paddingTop: '1.5rem', borderTop: '1px solid #e5e7eb' }}>
        ...
        <ul style={{ listStyle: 'disc', paddingLeft: '1.25rem', margin: 0 }}>
          <li style={{ marginBottom: '0.4rem' }}><a href="/blog/google-shopping-feed-optimization" style={{ color: 'var(--primary, #764ba2)', textDecoration: 'underline' }}>Google Shopping Feed Optimization: The Attribute-by-Attribute Build Order (2026)</a></li>
          <li style={{ marginBottom: '0.4rem' }}><a href="/blog/google-shopping-optimization" style={{ color: 'var(--primary, #764ba2)', textDecoration: 'underline' }}>Google Shopping Optimization: Diagnose First, Fix Second</a></li>
          <li style={{ marginBottom: '0.4rem' }}><a href="/blog/google-ads-optimizer-software-compared" style={{ color: 'var(--primary, #764ba2)', textDecoration: 'underline' }}>Google Ads Optimizer Software, Compared: Do You Actually Need One?</a></li>
          <li style={{ marginBottom: '0.4rem' }}><a href="/blog/why-is-my-google-ads-account-suspended" style={{ color: 'var(--primary, #764ba2)', textDecoration: 'underline' }}>Why Is My Google Ads Account Suspended? Causes, Fixes, and How to Appeal</a></li>
          <li style={{ marginBottom: '0.4rem' }}><a href="/blog/google-ads-ai-agent" style={{ color: 'var(--primary, #764ba2)', textDecoration: 'underline' }}>Google Ads AI Agent: What They Actually Do, Where They Break, and How to Choose (2026)</a></li>
          <li style={{ marginBottom: '0.4rem' }}><a href="/blog/landing-page-optimization-for-google-ads" style={{ color: 'var(--primary, #764ba2)', textDecoration: 'underline' }}>Landing Page Optimization for Google Ads (Quality Score Fix)</a></li>
          <li style={{ marginBottom: '0.4rem' }}><a href="/blog/performance-max-optimization" style={{ color: 'var(--primary, #764ba2)', textDecoration: 'underline' }}>Performance Max Optimization: The 7-Lever Playbook (In the Right Order)</a></li>
          <li style={{ marginBottom: '0.4rem' }}><a href="/blog/google-ads-agency-vs-in-house-vs-software" style={{ color: 'var(--primary, #764ba2)', textDecoration: 'underline' }}>Google Ads Agency vs In-House vs Software: Which Is Right for Your Budget?</a></li>
          <li style={{ marginBottom: '0.4rem' }}><a href="/blog/google-ads-management-software" style={{ color: 'var(--primary, #764ba2)', textDecoration: 'underline' }}>Google Ads Management Software: A Neutral Buyer's Guide to Choosing the Right Tool (2026)</a></li>
          <li style={{ marginBottom: '0.4rem' }}><a href="/blog/ad-hijacking-google-ads" style={{ color: 'var(--primary, #764ba2)', textDecoration: 'underline' }}>Ad Hijacking in Google Ads: How to Detect and Stop It</a></li>
          <li style={{ marginBottom: '0.4rem' }}><a href="/blog/google-ads-account-structure" style={{ color: 'var(--primary, #764ba2)', textDecoration: 'underline' }}>Google Ads Account Structure: The 2026 Setup Guide (Plus the 5-Minute Audit)</a></li>
          <li style={{ marginBottom: '0.4rem' }}><a href="/blog/google-ads-search-terms-report" style={{ color: 'var(--primary, #764ba2)', textDecoration: 'underline' }}>Google Ads Search Terms Report: What It Shows, What It Hides, and How to Act On It</a></li>
          <li style={{ marginBottom: '0.4rem' }}><a href="/blog/performance-max-negative-keywords" style={{ color: 'var(--primary, #764ba2)', textDecoration: 'underline' }}>Performance Max Negative Keywords: Account vs Campaign vs List Level, Real Limits, and When They Actually Help (2026)</a></li>
          <li style={{ marginBottom: '0.4rem' }}><a href="/blog/google-ads-experiments" style={{ color: 'var(--primary, #764ba2)', textDecoration: 'underline' }}>Google Ads Experiments: How to Run an A/B Test You Can Actually Trust</a></li>
        </ul>
      </div>
