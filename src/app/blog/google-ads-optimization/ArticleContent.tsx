    ...
    <>
      ...
      <div style={{ marginTop: '2.5rem', paddingTop: '1.5rem', borderTop: '1px solid #e5e7eb' }}>
        ...
        <ul style={{ listStyle: 'disc', paddingLeft: '1.25rem', margin: 0 }}>
          ...
          <li style={{ marginBottom: '0.4rem' }}><a href="/blog/google-ads-agency-vs-in-house-vs-software" style={{ color: 'var(--primary, #764ba2)', textDecoration: 'underline' }}>Google Ads Agency vs In-House vs Software: Which Is Right for You?</a></li>
