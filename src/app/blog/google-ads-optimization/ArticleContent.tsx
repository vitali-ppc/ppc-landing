    ...
    <>
      ...
      <div style={{ marginTop: '2.5rem', paddingTop: '1.5rem', borderTop: '1px solid #e5e7eb' }}>
        ...
        <ul style={{ listStyle: 'disc', paddingLeft: '1.25rem', margin: 0 }}>
          <li style={{ marginBottom: '0.4rem' }}><a href="/blog/google-shopping-feed-optimization" style={{ color: 'var(--primary, #764ba2)', textDecoration: 'underline' }}>Google Shopping Feed Optimization: The Attribute Build Order (2026)</a></li>
          ...
          <li style={{ marginBottom: '0.4rem' }}><a href="/blog/google-ads-management-software" style={{ color: 'var(--primary, #764ba2)', textDecoration: 'underline' }}>Google Ads Management Software: A Neutral Buyer's Guide (2026)</a></li>
          ...
          <li style={{ marginBottom: '0.4rem' }}><a href="/blog/google-ads-account-structure" style={{ color: 'var(--primary, #764ba2)', textDecoration: 'underline' }}>Google Ads Account Structure: The 2026 Setup Guide (Plus the 5-Minute Audit That Shows If Yours Is Quietly Burning Budget)</a></li>
