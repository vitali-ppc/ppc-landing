...
flowchart TD
  ...
  style Agency fill:#fef3c7,stroke:#f59e0b,stroke-width:2px
              ...
              <p style={{ fontSize: '18px', lineHeight: '1.8', color: '#1e293b', marginBottom: '32px' }}>
                <strong>Scenario 3: You use automation tools.</strong> Smart Bidding handles bids (if you have 30+ conversions/month), and a management tool like B6 handles budget pacing, negative keyword suggestions, and <a href="/blog/google-ads-anomaly-detection" style={{ color: '#764ba2', textDecoration: 'underline' }}>anomaly detection</a>. You spend 3-5 hours/week reviewing recommendations and approving changes. You&apos;re not doing the work manually. You&apos;re managing an AI team instead of a human team.
              </p>
              <p style={{ fontSize: '18px', lineHeight: '1.8', color: '#1e293b', marginBottom: '32px' }}>
