...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    type: 'article',
    images: [{ url: '/og/google-ads-roas-dropped-suddenly.png', width: 1200, height: 630, alt: 'Google Ads Roas Dropped Suddenly , kampaio.com/blog' }],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Google Ads ROAS Dropped Suddenly: 8 Diagnostic Steps',
    description: 'Most overnight ROAS drops are tracking issues in disguise. 8-step diagnostic with thresholds and timelines, built for SMB owners.',
    images: ['/og/google-ads-roas-dropped-suddenly.png'],
  },
};
