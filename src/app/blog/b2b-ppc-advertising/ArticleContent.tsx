        ...
        <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 24px 80px' }}>
          <div style={{ maxWidth: '800px', margin: '0 auto' }}>
            ...
            <section id="step-1">
              ...
              <p style={pStyle}>
                Performance Max and LinkedIn each have a place, but neither belongs in week one. Performance Max buys cheap volume across Google&apos;s whole network and gives you almost no control or visibility, which is why it tends to flood B2B accounts with low-quality leads. We cover that failure mode in <a href="/blog/performance-max-problems-b2b-marketing" style={linkStyle}>Performance Max problems in B2B marketing</a>. LinkedIn offers the best business targeting anywhere, by job title, company, and seniority, but at a much higher cost per click. For when LinkedIn earns its premium, see <a href="/blog/linkedin-ads-vs-google-ads-b2b-lead-generation" style={linkStyle}>LinkedIn Ads vs Google Ads for B2B</a>.
              </p>
            ...
            <section id="step-4">
              ...
              <p style={pStyle}>
                Set up conversion tracking that sees more than the form submission, because in a long B2B cycle the form-fill is the start of the story, not the end. Track the form, then track which forms became qualified leads, then feed back which ones closed.
              </p>
              <p style={pStyle}>
