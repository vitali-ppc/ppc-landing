    ...
    <>
      ...
      <div style={{ marginTop: '2.5rem', paddingTop: '1.5rem', borderTop: '1px solid #e5e7eb' }}>
        ...
        <ul style={{ listStyle: 'disc', paddingLeft: '1.25rem', margin: 0 }}>
          ...
          <li style={{ marginBottom: '0.4rem' }}><a href="/blog/incrementality-testing-google-ads" style={{ color: 'var(--primary, #764ba2)', textDecoration: 'underline' }}>Incrementality Testing in Google Ads: What It Measures and How to Run One</a></li>
