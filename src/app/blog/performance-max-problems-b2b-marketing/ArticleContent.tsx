    ...
    <>
      ...
      <div style={{ minHeight: '100vh', background: 'white' }}>
        ...
        <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '20px 24px 0' }}>
          <Breadcrumbs />
          <ArticleHero slug="performance-max-problems-b2b-marketing" />
        </div>
        {/* Article Header */}
          ...
          <div style={{ maxWidth: '800px', margin: '0 auto' }}>
            ...
            <section id="introduction">
              <p style={{ fontSize: '18px', lineHeight: '1.8', color: '#1e293b', marginBottom: '32px' }}>
                Performance Max (PMax) is Google's most automated campaign type, and it's revolutionized e-commerce and lead gen for many businesses. But for B2B marketers, it's often a source of frustration: poor lead quality, wasted budget, and a black box that's hard to control. If you're already seeing those symptoms, our diagnostic on <a href="/blog/performance-max-not-converting" style={{ color: '#764ba2', textDecoration: 'underline' }}>why Performance Max stops converting</a> covers the most common technical fixes.<br /><br />
            ...
            <section>
              ...
              <ol style={{ fontSize: '18px', color: '#1e293b', lineHeight: '1.8', paddingLeft: '24px', marginBottom: '40px' }}>
                ...
                <li id="problem-3" style={{ marginBottom: '24px' }}><strong>Broken Conversion Tracking:</strong> If your tracking isn't perfect, PMax will optimize for the wrong actions (or nothing at all). B2B tracking is notoriously tricky: think phone calls, offline sales, or multi-touch journeys. Our guide on <a href="/blog/google-ads-conversion-tracking-not-working" style={{ color: '#764ba2', textDecoration: 'underline' }}>why Google Ads conversion tracking breaks</a> covers the failure modes specific to long sales cycles.</li>
        ...
        <KeepReading slug="performance-max-problems-b2b-marketing" category="google-ads" />
      <Footer compact={true} />
      </div>
    </>
  );
