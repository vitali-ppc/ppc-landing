          ...
          <div style={{ maxWidth: '800px', margin: '0 auto' }}>
            ...
            <section>
              ...
              <ol style={{ fontSize: '18px', color: '#1e293b', lineHeight: '1.8', paddingLeft: '24px', marginBottom: '40px' }}>
                ...
                <li id="tip-2" style={{ marginBottom: '24px' }}><strong>Garbage In, Garbage Out: Why Your AI Needs Clean Data:</strong> The better your data (conversion tracking, audience signals, negative keywords), the smarter your AI will become. Regularly audit your data sources for accuracy. If your tracking is shaky to begin with, see <a href="/blog/google-ads-conversion-tracking-not-working" style={{ color: '#764ba2', textDecoration: 'underline' }}>why Google Ads conversion tracking breaks</a> before you let AI optimize on bad signals.</li>
