        ...
        <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 24px 80px' }}>
          <div style={{ maxWidth: '800px', margin: '0 auto' }}>
            ...
            <section id="three-ways">
              ...
              <p style={{ fontSize: '18px', lineHeight: '1.8', color: '#1e293b', marginBottom: '32px' }}>
                Software splits into two kinds, and the difference matters for this comparison. Recommendation tools like Optmyzr, WordStream, and Adzooma tell you what to do, but you still log in and execute every change by hand. This is the automation ceiling: the tool surfaces the work, you still do it. Self-serve AI tools like Kampaio actually run the work and show each step live, so you review and approve rather than execute. Agency-side comparisons usually skip this distinction or lump all software into the recommendation bucket, which is where they get the third option wrong.
              </p>
              <p style={{ fontSize: '18px', lineHeight: '1.8', color: '#1e293b', marginBottom: '32px' }}>
