        ...
        <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 24px 80px' }}>
          <div style={{ maxWidth: '800px', margin: '0 auto' }}>
            ...
            <section id="tldr">
              ...
              <p style={pStyle}>
                Your CPC is high for one of nine reasons that group into four buckets: auction math (<a href="/blog/the-complete-guide-to-google-ads-quality-score-in-2025" style={linkStyle}>Quality Score</a> below 6, weak ad relevance), account hygiene (broad match feeding junk queries, no negatives), structure (one mega ad group with 80 keywords), or bidding <a href="/blog/google-ads-strategy" style={linkStyle}>strategy</a> (Maximize Clicks pushing CPC up, or Smart Bidding still learning). The triage takes 30 seconds: pull the Quality Score column, sort search terms by cost, check your bid strategy. From there, three of the nine causes will account for 80% of your inflated CPC. First, though, confirm the CPC is actually too high: our <a href="/tools/roas-calculator" style={linkStyle}>break-even ROAS calculator</a> gives the max CPA (and implied CPC) your margin can profitably support.
              </p>
