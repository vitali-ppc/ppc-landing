...
export const metadata: Metadata = {
  title: 'B2B SaaS Google Ads Benchmarks 2026: CPC, CPA vs LinkedIn',
  description: 'B2B SaaS Google Ads benchmarks for 2026: CPC $5.34, CPA $87-$1,500+, CVR 3-5%, plus how they compare to LinkedIn Ads CPC and CPL by vertical.',
  alternates: {
