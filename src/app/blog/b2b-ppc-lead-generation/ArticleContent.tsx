        ...
        <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 24px 80px' }}>
          <div style={{ maxWidth: '800px', margin: '0 auto' }}>
            ...
            <section id="system">
              ...
              <p style={pStyle}>
                The reason it has to be a system is that the levers are coupled. Tighter intent narrows the audience the channels reach. The channels generate the raw conversions the feedback loop refines. The feedback loop only works if measurement defines the right outcome to send back. Break the chain at any link and the upstream work is wasted. An account with perfect negative keywords and no CRM feedback loop still trains its bidder on form fills, and an account with a flawless feedback loop and broad-match chaos still drowns the signal in junk.
              </p>
              <p style={pStyle}>
            ...
            <section id="scale">
              ...
              <p style={pStyle}>
                At $100K and above the constraint is organizational. The levers are known; the issue is whether anyone has the time and the operating cadence to run them weekly. This is where the build-versus-buy decision gets real, and where automating the operational layer earns its keep. Tools like Optmyzr and Madgicx start at $499 a month, which is itself a meaningful line item; Kampaio runs $99 to $399 depending on how much autonomy you hand the agents. The broader strategic framing of how a paid program should evolve as it scales is the subject of the sibling pillar, <a href="/blog/google-ads-strategy" style={linkStyle}>Google Ads strategy: a strategic operator&apos;s framework</a>.
              </p>
