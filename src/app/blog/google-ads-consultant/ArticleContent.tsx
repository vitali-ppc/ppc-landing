        ...
        <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 24px 80px' }}>
          <div style={{ maxWidth: '800px', margin: '0 auto' }}>
            ...
            <section id="what-they-do">
              ...
              <p style={pStyle}>
                A Google Ads consultant is paid to find and fix what a dashboard alone will not surface. That breaks down into six deliverables: <strong>account audit</strong> (structure, budget, bidding, search-terms waste), <strong>campaign structure</strong> (reorganizing so Smart Bidding signals are not diluted), <strong>keyword and negative-keyword strategy</strong> (cutting leakage into irrelevant queries), <strong>bid and budget management</strong> (Target ROAS, Target CPA, Performance Max splits), <strong>ad copy and RSA testing</strong>, and <strong>conversion tracking and reporting</strong> you can actually act on.
              </p>
              <p style={pStyle}>
