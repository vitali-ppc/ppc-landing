...
flowchart TD
  ...
  H -- Yes --> J[Analyze, report lift,<br/>act on result]
            ...
            <section id="cta">
              ...
              <p style={pStyle}>
                The cost structure: B6 at $199 a month on the Approval tier, versus Optmyzr at roughly $499 a month for recommendation-only insights, versus the typical agency that will quote $4-8K for one custom incrementality study. Connect your account at <a href="/chat" style={linkStyle}>/chat</a> and Sage will design a default geo-lift across your top three campaigns inside 5 minutes. Pricing tiers and what each agent does in each tier are at <a href="/pricing" style={linkStyle}>/pricing</a>.
              </p>
            </section>
